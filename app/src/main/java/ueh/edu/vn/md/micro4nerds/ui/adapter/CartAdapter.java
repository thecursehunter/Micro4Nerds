...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartViewHolder> {
    ...
    public CartAdapter(Context context, ArrayList<CartItem> cartItems, CartItemListener listener) {
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, int position) {
        ...
        holder.tvProductPrice.setText(String.format(Locale.US, "$ %.2f", cartItem.getProductPrice()));
        ...
        if (cartItem.getQuantity() == 1) {
            holder.btnDecrease.setAlpha(0.5f); // Làm mờ nút
            holder.btnDecrease.setEnabled(false); // Vô hiệu hóa nút
        } else {
