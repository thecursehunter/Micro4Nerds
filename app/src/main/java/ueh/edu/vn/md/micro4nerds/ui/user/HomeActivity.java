...
public class HomeActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void observeData() {
        ...
        productViewModel.getProductList().observe(this, products -> {
            if (products != null && !products.isEmpty()) productAdapter.setProductList(products);
        });
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) filterKeyword = "";
        else if (id == R.id.nav_camera_panasonic) filterKeyword = "Panasonic";
        else if (id == R.id.nav_camera_olympus) filterKeyword = "Olympus";
        else if (id == R.id.nav_camera_om) filterKeyword = "OM";
        else if (id == R.id.nav_camera_blackmagic) filterKeyword = "Blackmagic";
        else if (id == R.id.nav_acc_lens) filterKeyword = "Lens";
        else if (id == R.id.nav_acc_bag) filterKeyword = "Túi";
        else if (id == R.id.nav_profile) {
            if (new SharedPrefManager(this).isLoggedIn()) startActivity(new Intent(this, ProfileActivity.class));
